...
public class SpecController {
    ...
    public Result<List<Map<String, Object>>> findByCategoryName(@PathVariable("categoryName") String categoryName){
        List<Map<String, Object>> list = specService.findByCategoryName(categoryName);
        return new Result<>(true,StatusCode.OK,"查询成功",list);
    }
